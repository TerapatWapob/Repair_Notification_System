        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ticket>().HasData(
                new Ticket
                {
                    ...
                    ProblemDescription = "ทดสอบรายละเอียด 1",
                    AgentComment = null,
                ...
                new Ticket
                {
                    ...
                    Topic = "ตั๋วทดสอบ 2",
                    TypeOfProblem = "ปัญหาเกี่ยวกับฮาร์ดแวร์/อุปกรณ์",
                    ProblemDescription = "ทดสอบรายละเอียด 2",
                    AgentComment = null,
                ...
                new Ticket
                {
                    ...
                    ProblemDescription = "ทดสอบรายละเอียด 3",
                    AgentComment ="ข้อความทดสอบจากเจ้าหน้าที่",
                ...
                new Ticket
                {
                    ...
                    ProblemDescription = "ทดสอบรายละเอียด 4",
                    AgentComment ="ข้อความทดสอบจากเจ้าหน้าที่",
                    State = TicketState.ดำเนินการเสร็จสิ้น,
                    AgencyID = 2
                },
                new Ticket
                {
                    ...
                    Topic = "ตั๋วทดสอบ 5",
                    TypeOfProblem = "อื่นๆ",
                    ProblemDescription = "ทดสอบรายละเอียด 5",
                    AgentComment ="ข้อความทดสอบจากเจ้าหน้าที่",
                    State = TicketState.ดำเนินการเสร็จสิ้น,
                    AgencyID = 2
                }
